...
class Resize(object):
    ...
    def __call__(self, image, boxes, masks, im_info, flipped):
        ...
        size = (self.min_size, self.max_size) #self.get_size(origin_size)
...
class ColorChange(object):
    def __call__(self, image, boxes, masks, im_info, flipped):
        image_color = T.ColorJitter(brightness=0.1,contrast=0.1,saturation=0.1,hue=0.0)(image)
        return image_color, boxes, masks, im_info, flipped
